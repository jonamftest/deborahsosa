...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tasaciones</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
		             ...
		             <tbody>
		              <?php 
						...
						$sql = " SELECT `id`, `nombre`, `telefono`, `email`, `operacion`, `propiedad`, `barrio`, `comentarios` FROM `tasaciones` WHERE 1 ";
						...
						foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>'. $row[7] . '</td>';
								echo '<td>';
								echo '<a href="eliminarTasacion.php?id='.$row[0].'"><img src="img/icon_baja.png" width="24" height="25" border="0" alt="Eliminar" title="Eliminar"></a>';
								echo '&nbsp;';
							   	echo '</td>';
							   	echo '</tr>';
					   }
