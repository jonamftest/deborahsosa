...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
				<p>
				<a href="nuevaTarea.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nueva" title="Nueva"></a>
				</p>
                <div class="col-lg-12">
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
		             ...
		             <tbody>
		              <?php 
						...
						$sql = " SELECT t.`id`, r.`nombre`, t.`dias`, t.`horarios` FROM `tareas` t inner join reglas r on r.id = t.id_regla WHERE 1 ";
						...
						foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>'. $row[3] . '</td>';
								echo '<td>';
								echo '<a href="eliminarTarea.php?id='.$row[0].'"><img src="img/icon_baja.png" width="24" height="25" border="0" alt="Eliminar" title="Eliminar"></a>';
								echo '&nbsp;';
							   	echo '</td>';
							   	echo '</tr>';
					   }
