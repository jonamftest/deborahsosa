...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
				<p>
				<a href="nuevaComision.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nueva" title="Nueva"></a>
				</p>
                <div class="col-lg-12">
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
		             ...
		             <tbody>
		              <?php 
						...
						$sql = " SELECT co.`id`, co.`comision`, co.`valor`, co.`es_fijo` FROM `comisiones` co WHERE 1 ";
						...
						foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>';
								echo '<a href="modificarComision.php?id='.$row[0].'"><img src="img/icon_modificar.png" width="24" height="25" border="0" alt="Modificar" title="Modificar"></a>';
								echo '&nbsp;';
							   	echo '<a href="eliminarComision.php?id='.$row[0].'"><img src="img/icon_baja.png" width="24" height="25" border="0" alt="Eliminar" title="Eliminar"></a>';
								echo '&nbsp;';
							   	echo '</td>';
							   	echo '</tr>';
					   }
