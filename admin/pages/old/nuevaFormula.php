<?php
	...
	if ( !empty($_POST)) {
		...
		$sql = "INSERT INTO `formulas`(`nombre`, `formula`, `activa`) VALUES (?,?,1)";
		$q = $pdo->prepare($sql);
		$q->execute(array($_POST['nombre'],$_POST['formula']));
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Nueva Fórmula</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="nuevaFormula.php">
										...
										<div class="form-group">
                                            <label>Fórmula</label>
											<textarea class="form-control" required="required" name="formula" id="formula"></textarea>
											<br>
											Agregar Impuesto: 
