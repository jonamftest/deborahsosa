<?php
	...
	if ( !empty($_POST)) {
		...
		$sql = "INSERT INTO `impuestos`(`nombre`, `es_fijo`, `valor`) VALUES (?,?,?)";
		$q = $pdo->prepare($sql);
		$q->execute(array($_POST['nombre'],$_POST['es_fijo'],$_POST['valor']));
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Nuevo Impuesto</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="nuevoImpuesto.php">
