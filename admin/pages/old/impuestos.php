...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
				<p>
				<a href="nuevoImpuesto.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nuevo" title="Nuevo"></a>
				</p>
                <div class="col-lg-12">
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
		             ...
		             <tbody>
		              <?php 
						...
						$sql = " SELECT `id`, `nombre`, `es_fijo`, `valor` FROM `impuestos` WHERE 1 ";
						...
						foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>';
								echo '<a href="modificarImpuesto.php?id='.$row[0].'"><img src="img/icon_modificar.png" width="24" height="25" border="0" alt="Modificar" title="Modificar"></a>';
								echo '&nbsp;';
							   	echo '<a href="eliminarImpuesto.php?id='.$row[0].'"><img src="img/icon_baja.png" width="24" height="25" border="0" alt="Eliminar" title="Eliminar"></a>';
								echo '&nbsp;';
							   	echo '</td>';
							   	echo '</tr>';
					   }
