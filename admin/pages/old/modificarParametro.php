<?php
	...
	if ( !empty($_POST)) {
		...
		$q = $pdo->prepare($sql);
		$q->execute(array($_POST['valor'],$id));
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Modificar Parámetro</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form class="form-horizontal" action="modificarParametro.php?id=<?php echo $id?>" method="post">
										<div class="form-group">
                                            <label>Parámetro</label>
											<input name="parametro" type="text" maxlength="99" class="form-control" value="<?php echo $data['parametro']; ?>" readonly="readonly">
										</div>
										<div class="form-group">
                                            <label>Valor</label>
									...
									<br><br>
									<button onclick="document.location.href='parametros.php'" class="btn btn-default">Volver</button>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                            </div>
                            <!-- /.row (nested) -->
