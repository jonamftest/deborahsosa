<?php
	...
	if ( !empty($_POST)) {
		...
		$sql = "INSERT INTO `comisiones`(`comision`, `valor`, `es_fijo`) VALUES (?,?,?)";
		$q = $pdo->prepare($sql);
		$q->execute(array($_POST['comision'],$_POST['valor'],$_POST['es_fijo']));
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Nueva Comisión</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="nuevaComision.php">
										<div class="form-group">
                                            <label>Comisión</label>
											<input name="comision" type="text" maxlength="99" class="form-control" value="" required="required">
										</div>
										<div class="form-group">
