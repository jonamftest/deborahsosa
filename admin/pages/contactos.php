                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
		             ...
		             <tbody>
		              <?php 
						...
						$sql = " SELECT `id`, `nombre`, `email`, `telefono`, `asunto`, `motivo`, `mensaje` FROM `contactos` WHERE 1 ";
						...
						foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>'. $row[6] . '</td>';
								echo '<td>';
								echo '<a href="eliminarContacto.php?id='.$row[0].'"><img src="img/icon_baja.png" width="24" height="25" border="0" alt="Eliminar" title="Eliminar"></a>';
								echo '&nbsp;';
							   	echo '</td>';
							   	echo '</tr>';
					   }
